-- Estilo da Ilha — schema do catálogo (produtos e categorias)
...
insert into categories (key, label, description, image, sort_order) values
  ...
  ('bermuda', 'Bermudas', 'Pra aguentar o calor da ilha', '/products/bermuda-sarja.jpg', 4),
  ('kits', 'Kits', 'Combos fechados sob consulta', '/products/kit-oversized.jpg', 5),
...
values
  ('asuna-2-0', 'Sandália Nike Asuna 2.0', 135.00, null, '/products/asuna-2-0.jpg', 'sandalia', 'Sandálias', 'NOVO', array['38','39','40','41','42','43'], 'Sandália slide Nike Asuna 2.0, confortável no dia a dia da ilha. Consulte disponibilidade de cor e numeração.', true, true, false),
  ...
  ('sandalia-kenner', 'Sandália Kenner', 119.90, null, '/products/kenner-slide.jpg', 'sandalia', 'Sandálias', 'NOVO', array['38','39','40','41','42','43'], 'Sandália Kenner nacional, resistente e confortável para o dia a dia na ilha.', true, true, false),
  ...
  ('kit-algodao', 'Kit Algodão', 0, null, '/products/kit-algodao.jpg', 'kits', 'Kits', null, array['P','M','G','GG'], 'Kit fechado em algodão, quantidade e peças a combinar direto com a loja pelo WhatsApp.', false, false, true),
  ('kit-oversized', 'Kit Oversized', 0, null, '/products/kit-oversized.jpg', 'kits', 'Kits', null, array['P','M','G','GG'], 'Kit de camisetas oversized, quantidade e peças a combinar direto com a loja pelo WhatsApp.', false, false, true),
  ('kit-polo', 'Kit Polo', 0, null, '/products/kit-polo.jpg', 'kits', 'Kits', null, array['P','M','G','GG'], 'Kit de camisas polo, quantidade e peças a combinar direto com a loja pelo WhatsApp.', false, false, true),
  ('kit-zara', 'Kit Zara', 0, null, '/products/kit-zara.jpg', 'kits', 'Kits', null, array['P','M','G','GG'], 'Kit de looks estilo Zara, quantidade e peças a combinar direto com a loja pelo WhatsApp.', false, false, true)
